...
const imageUrlBuilder = function (locations) {
  ...
  const firstBizMark = `markers=anchor:center%7Cicon:http://i.imgur.com/tumjuoO.png|${firstBizLoc}&`;
  const secondBizMark = `markers=anchor:center%7Cicon:http://i.imgur.com/tumjuoO.png|${secondBizLoc}&`;
  const thirdBizMark = `markers=anchor:center%7Cicon:http://i.imgur.com/tumjuoO.png|${thirdBizLoc}&`;
